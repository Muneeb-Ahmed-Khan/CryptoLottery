            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group" style=" float: right; width: 47%; height: 100%;">
                        ...
                        <form method="POST" actions="{{ url('admin/'.$lottery[0]->id) }}">
                        @csrf
                            <div class="form-group">
                                <label class="control-label">Winning User</label>
                                <input type="text" name="winning_user" type="text" class="form-control" placeholder="Transaction ID..."/>
                            </div>
                            <button type="submit" name="open_lottery" style="width:100%;" class="btn btn-primary">Open Lottery</button>
                        </form>
